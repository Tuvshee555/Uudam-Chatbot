...
export function buildProposalGuide(condensedTrips: unknown): string {
  return [
    ...
    "- Аяллын нэрийг ХАШИЛТАНД бич (ж: \"<Аяллын нэр>\").",
    ...
    "- Сайн жишээ: { \"text\": \"\\\"<Аяллын нэр>\\\"-ыг шинэ аялал болгон нэмэх үү, эсвэл одоо байгааг шинэчлэх үү?\", \"severity\": \"blocker\", \"type\": \"duplicate_route\" }",
