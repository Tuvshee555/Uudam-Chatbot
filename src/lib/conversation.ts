...
export function buildPrompt(options: {
  ...
  lines.push("- Once you have collected a phone number, say: 'Баярлалаа! Манай аяллын зөвлөх удахгүй тантай холбогдох болно 🙌' — then stop offering more trip details. The human consultant will take over.");
