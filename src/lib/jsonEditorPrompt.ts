...
1. Аялал бүрт "price_groups" талбарыг нэм. Хэрэв аялал огноо тус бүрт өөр өөр үнэтэй бол тус тусад нь бич. Жишээ:
   "price_groups": [
     { "label": "6 сарын үнэ", "dates": ["6 сарын 27"], "adult_price": 1111111, "child_price": 999999, "infant_price": null, "child_age": "2-12 нас", "infant_age": "0-2 нас", "note": "" },
     { "label": "7/8 сарын үнэ", "dates": ["7 сарын 18", "8 сарын 8"], "adult_price": 2222222, "child_price": 999999, "infant_price": null, "child_age": "2-12 нас", "infant_age": "0-2 нас", "note": "" }
   ]

2. Аялал бүрт "discounts" талбарыг нэм (хямдрал байвал). Жишээ:
   "discounts": [
     { "label": "Эрт захиалгын хямдрал", "dates": [], "adult_price": 1111111, "child_price": 999999, "infant_price": null, "condition": "7 хоногийн өмнө захиалбал", "note": "" }
   ]

3. Аялал бүрт "aliases" талбарыг нэм — хэрэглэгчид хэрхэн хайдаг болохыг бод. Жишээ:
   "aliases": ["<Хот> <Хот>", "<Хот> <Газар>"]

4. Аялал бүрт "child_rules" талбарыг нэм (хүүхдийн насны ангилал байвал). Жишээ:
   "child_rules": [
     { "label": "Хүүхэд", "age_range": "2-12 нас", "price": 1111111, "note": "" },
     { "label": "Нярай", "age_range": "0-2 нас", "price": 111111, "note": "" }
   ]
