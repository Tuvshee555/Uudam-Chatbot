...
const cases: QaCase[] = [
  ...
  { id: "draft-shanghai", text: "Шанхай Ханжоу хэд вэ?", expect: ["Шанхай+Ханжоу", "3,220,000₮", "1,450,000₮"], reject: ["ШАНХАЙ ХӨТӨЛБӨРТЭЙ", "1,510,000"], note: "Draft Shanghai trip must stay hidden." },
  { id: "tenger-direct", text: "Тэнгэрийн хаалга шууд нислэгтэй нь хэд вэ?", expect: ["Тэнгэрийн хаалга - шууд нислэгтэй", "1,430,000₮", "1,410,000₮"], reject: ["1,400,000₮", "газар+нислэг"], note: "Direct-flight Tenger and combo Tenger are different products." },
  { id: "tenger-combo", text: "Тэнгэрийн хаалга газар нислэг хосолсон нь хэд вэ?", expect: ["Тэнгэрийн хаалга — газар+нислэг", "1,400,000₮", "1,340,000₮"], reject: ["1,430,000₮"], note: "Combo Tenger should not inherit direct-flight price." },
  { id: "cruise-null-base", text: "Усан онгоцны аялал Чежү Пусан хэд вэ?", expect: ["Усан онгоцны аялал", "1,210,000₮", "710CNY"], reject: ["тодорхойгүй"], note: "Null top-level price must use price_groups and show mandatory fees." },
  { id: "exam-fee-total", text: "Хөх хотын шинжилгээтэй аялал нийт хэдэн төгрөг болох вэ?", expect: ["Хөх хотын шинжилгээтэй", "1,100,000₮", "1,060,000₮", "600CNY", "300CNY"], note: "Base MNT plus CNY exam fees must be visible." },
  ...
  { id: "ocr-zhangjiajie", text: "Шанхай Жанжиажэ аяллын үнэ хэд вэ?", expect: ["Шанхай + Тэнгэрийн хаалга", "3,590,000₮", "1,500,000₮", "800CNY"], note: "OCR/alias correction: Жанжиажэ maps to Shanghai + Tenger." },
  { id: "sanya-age-2", text: "Хайнан Саньяа 2 настай хүүхэд хэдээр явах вэ?", expect: ["Хайнан - Саньяа", "2-6 нас", "1,280,000₮"], reject: ["1,410,000₮", "1,030,000₮"], note: "Single child age must choose 2-6 tier." },
  { id: "sanya-age-7", text: "Хайнан Саньяа 7 настай хүүхэд хэд вэ?", expect: ["Хайнан - Саньяа", "6-12 нас", "1,410,000₮"], reject: ["1,280,000₮"], note: "Single age 7 should choose 6-12 tier." },
  { id: "tokyo-ticketed", text: "Токио Фүжи аяллын онгоцны тийзтэй үнэ хэд вэ?", expect: ["Токио, Фүжи", "Онгоцны тийзтэй үнэ", "5,600,000₮", "1,550,000₮", "211,000MNT"], reject: ["1,490,000₮", "Онгоцны тийзгүй үнэ"], note: "Ticketed Tokyo price group must be isolated." },
  { id: "tokyo-ticketless", text: "Токио Фүжи аяллын онгоцны тийзгүй үнэ хэд вэ?", expect: ["Токио, Фүжи", "Онгоцны тийзгүй үнэ", "1,490,000₮", "1,460,000₮", "211,000MNT"], reject: ["5,600,000₮", "Онгоцны тийзтэй үнэ"], note: "Ticketless Tokyo price group must be isolated." },
  { id: "dalian-discount", text: "Далянь аялал хямдралтай юу үндсэн үнэ хэд вэ?", expect: ["Далянь", "Үндсэн үнэ", "1,420,000₮", "2 том хүн + 1 хүүхэд үнэгүй"], note: "Discount answer should still show base price." },
  { id: "beidaihe-land", text: "Бэйдайхэ Бээжин нислэггүй газрын аялал байгаа юу?", expect: ["ШАР ТЭНГИС", "1,160,000₮", "1,120,000₮"], reject: ["газар нислэг хосолсон", "1,270,000₮"], note: "Land-only phrasing should exclude combo tour." },
  { id: "beidaihe-combo", text: "Бэйдайхэ Бээжин газар нислэг хосолсон аялал хэд вэ?", expect: ["Бэйдайхэ", "газар нислэг хосолсон", "1,270,000₮", "1,200,000₮"], reject: ["1,160,000₮"], note: "Combo phrasing should exclude land-only tour." },
  { id: "hailaar-5-late", text: "Хайлаар Манжуур 5 өдөр 8 сарын 24-нд хэд вэ?", expect: ["Хайлаар Манжуурын аялал - 5 өдөр 4 шөнө", "8 сарын 24", "1,100,000₮", "1,100,000₮", "250,000MNT"], reject: ["1,120,000₮"], note: "Date-specific late-August Hailaar 5-day price differs." },
  { id: "hailaar-4-late", text: "Хайлаар Манжуур 4 өдөр 8 сарын 21-нд хэд вэ?", expect: ["Хайлаар Манжуурын аялал - 4 өдөр 3 шөнө", "8 сарын 21", "1,100,000₮", "1,080,000₮", "200,000MNT"], reject: ["1,110,000₮"], note: "Date-specific late-August Hailaar 4-day price differs." },
  { id: "jeju-fee", text: "Жэжү арлын шууд нислэгтэй аялал хэд вэ нийт зардал?", expect: ["Жэжү арлын шууд нислэгтэй", "1,540,000₮", "1,520,000₮", "900,000MNT"], note: "Jeju extra single-room fee should be visible." },
  ...
  { id: "macau-alias", text: "Макао Жухай Хайлан арал хэд вэ?", expect: ["Макао - Жухай - Хайлин арал", "1,380,000₮", "1,280,000₮"], note: "Alias typo Хайлан should match Хайлин." },
  { id: "guangzhou-alias", text: "Гуанжоу Макао Шэнжин аяллын үнэ хэд вэ?", expect: ["Гуанжоу, Макао, Шэнжин", "1,380,000₮", "1,280,000₮"], note: "Multi-city route alias should match." },
  { id: "jinin-mini-free-vs-paid", text: "Жинин Мини аватар Хөх хот үнэгүй шинжилгээтэй нь хэд вэ?", expect: ["Жинин-Мини аватар-Хөх хотын аялал", "1,100,000₮", "1,070,000₮"], reject: ["үнэтэй шинжилгээтэй"], note: "Free/paid exam variants should not be confused." },
  { id: "jinin-mini-paid-vs-free", text: "Жинин Мини аватар Хөх хот үнэтэй шинжилгээтэй нь нийт хэд вэ?", expect: ["Жинин - Мини аватар - Хөх хот + үнэтэй шинжилгээтэй", "1,100,000₮", "1,070,000₮", "600CNY", "300CNY"], note: "Paid exam variant should surface CNY fees." },
];
