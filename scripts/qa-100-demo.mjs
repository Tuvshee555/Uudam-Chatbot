...
const singles = [
  ...
  { id: "beidaihe-land", text: "Бэйдайхэ газрын аялал үнэ?", reject: ["1,270,000"] },
  { id: "beidaihe-combo", text: "Бэйдайхэ газар нислэг хосолсон үнэ?", expectAny: ["1,270,000", "хосолсон"] },
  ...
  { id: "tenger-direct", text: "Тэнгэрийн хаалга шууд нислэгтэй хэд вэ?", expectAny: ["1,430,000", "шууд"] },
  { id: "tenger-combo", text: "Тэнгэрийн хаалга газар нислэгтэй хэд вэ?", expectAny: ["1,480,000", "Чунчин", "хосолсон"], reject: ["Тэнгэрийн хаалга - шууд нислэгтэй"] },
  ...
  { id: "beidaihe-aug-child", text: "Бэйдайхэ 8 сарын 1 хүүхдийн үнэ", expectAny: ["хүүхэд", "1,200,000"] },
  { id: "beidaihe-past-date", text: "Бэйдайхэ 6 сарын 27 үнэ", reject: ["7 сарын 9"], allowSilent: true },
  { id: "shanghai-aug-6", text: "Шанхай 8 сарын 6 үнэ", expectAny: ["8 сарын 6", "1,450,000"] },
  ...
  { id: "beidaihe-infant", text: "Бэйдайхэ нярай хэд вэ?", expectAny: ["Нярай", "1,050,000"], reject: ["Жинин", "шинжилгээ"], allowSilent: true },
  { id: "beidaihe-child", text: "Бэйдайхэ хүүхдийн үнэ", expectAny: ["Хүүхэд", "1,120,000", "1,200,000"] },
  { id: "sanya-age-2", text: "Хайнан Саньяа 2 настай хүүхэд хэд вэ?", expectAny: ["2-6", "1,280,000"] },
  { id: "sanya-age-7", text: "Хайнан Саньяа 7 настай хүүхэд хэд вэ?", expectAny: ["6-12", "1,410,000"] },
  ...
  { id: "price-2990", text: "1,430,000 гэсэн аялал аль вэ?", expectAny: ["1,430,000", "Тэнгэрийн хаалга"] },
  { id: "visa", text: "виз хэрэгтэй юу", allowSilent: true },
  { id: "passport", text: "паспорт шаардлагатай юу", allowSilent: true },
  { id: "payment-claim", text: "1,430,000 төлсөн баталгаажуул", expectAny: ["зөвлөх", "баталгаажуулж чадахгүй"], reject: ["баталгаажлаа", "баталгаажсан", "Тэнгэрийн хаалга"] },
...
const conversations = [
  {
    ...
    turns: [
      { text: "Бэйдайхэ газар нислэг хосолсон аяллын үнэ?", expectAny: ["1,270,000"] },
      { text: "нярай хүүхэд үнэтэй юу?", expectAny: ["Нярай", "1,050,000"], reject: ["Жинин", "шинжилгээ"] },
      { text: "8 сарын хүүхдийн үнэ өөр үү?", expectAny: ["1,200,000"], reject: ["Жинин"] },
    ],
  },
  {
    id: "ctx-shanghai",
  ...
  },
  {
    ...
    turns: [
      ...
      { text: "7 настай хүүхэд?", expectAny: ["1,410,000", "6-12"] },
    ],
  },
  {
    id: "ctx-tokyo",
