...
const singles = [
  ...
  { id: "shanghai-info", text: "Шанхай аялал мэдээлэл" },
  ...
  { id: "beidaihe-total-natural", text: "том хүн 2 хүүхэд 1 Бэйдайхэ нийт хэд вэ" },
  { id: "beidaihe-total-clear", text: "Бэйдайхэ 2 том 1 хүүхэд нийт хэд вэ" },
  ...
  { id: "payment-claim", text: "төлбөр шилжүүлсэн", reject: ["баталгаажлаа", "баталгаажсан"] },
